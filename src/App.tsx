        ...
        <div className="app-container">
            ...
            <footer className="footer">
                <div className="footer-links">
                    <a href="https://github.com/placeholder/dropop" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                ...
                <div>
                    DropOp is provided as-is, free of charge, no fees. Use at your own risk.
                </div>
            </footer>
        </div>
    );
